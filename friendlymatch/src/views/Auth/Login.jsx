...
function Login({ firebase, history }) {
    ...
    form = (
      <form id="sign-in-form" action="#" className="container">
        ...
        <p className="terms">
          ...
          <a href="http://localhost:3000/TermsAndPrivacy">Terms of Service</a>{" "}
          and <a href="http://localhost:3000/TermsAndPrivacy">Privacy Policy</a>
        </p>
      </form>
    );
  ...
  return (
    <>
      <div className="formContainerLogin">{form}</div>
    </>
  );
}
