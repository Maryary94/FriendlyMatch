  ...
  return (
    <>
      ...
      <div className="CreateGroupName">
        ...
        <Input id="GroupName" type="text" placeholder="Name of the Group" onChange={e => name.current = e.target.value}/>
      ...
      <div className="ButtonCreateGroup">
        <Button id="btn-verify" name="Confirm" btnColor="success" onClick={handleCreateGroup}/>
      </div>
    </>
  );
}
